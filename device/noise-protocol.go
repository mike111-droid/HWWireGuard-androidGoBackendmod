...
type Handshake struct {
	...
	/* Custom change begin */
	// Initiator fills this with its own public ephemeral key
	// Responder fills this with Initiators public ephemeral key
	sharedUniqueSecret       NoisePublicKey
	/* Custom change end */
}
...
func (device *Device) CreateMessageInitiation(peer *Peer) (*MessageInitiation, error) {
	...
	/* Custom change begin */
	handshake.sharedUniqueSecret = handshake.localEphemeral.publicKey()
	/* Custom change end */
...
func (device *Device) ConsumeMessageInitiation(msg *MessageInitiation) *Peer {
	...
	/* Custom change begin */
	handshake.sharedUniqueSecret = handshake.remoteEphemeral
	/* Custom change end */
